 ...
 * 
 */
@WebServiceClient(name = "userServiceService", targetNamespace = "http://soap.userServer.feec.cz/", wsdlLocation = "http://localhost:8888/UserServer-1.0/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://soap.userServer.feec.cz/", "userServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/UserServer-1.0/userService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://soap.userServer.feec.cz/", "userServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.userServer.feec.cz/", "userServicePort"), UserService.class, features);
    }
